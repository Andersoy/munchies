...
<template>
  <div class="bg-[#00703A] w-screen h-screen flex flex-col justify-between">
    ...
    <button
      ...
      class="w-[327px] h-[56px] py-5 px-6 rounded-lg border border-white mb-6 text-[16px] font-bold leading-none tracking-[-0.5px] text-white bg-transparent mx-auto block cursor-pointer"
    >
      Continue
    </button>
  </div>
